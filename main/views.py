...
def your_view(request):
    ...
    mutation_rate = 0.01
    generations = 100
    best_individual = genetic_algorithm(boxes_second, num_cars, cities, car_capacity, population_size, elite_size, mutation_rate, generations)

    best_fitness = fitness(best_individual, boxes_second, num_cars, cities, car_capacity)
    best_car_destinations = car_items(num_cars, boxes_second, best_individual)
